...
console.log('');
console.log('  12宮位:');
Object.entries(reading.purpleStar.palaces).forEach(([palace, star]) => {
  console.log(`    ${palace}: ${star}`);
});
console.log('');
...
console.log('');
console.log('  事業階段:');
reading.career.stages.forEach(s => {
  console.log(`    ${s.age}: ${s.focus}`);
});
console.log('');
...
console.log('');
console.log('  桃花年運:');
reading.love.yearly.forEach(y => {
  console.log(`    ${y.year}: ${y.status}`);
});
console.log('');
...
console.log(`  建議: ${reading.health.advice}`);
console.log('');
...
console.log('');
console.log(`  再下一步: ${reading.daYun.next2.years} (${reading.daYun.next2.age})`);
console.log(`    → ${reading.daYun.next2.theme}`);
console.log('');
...
console.log('═══════════════════════════════════════════════════════════════');
console.log('');
console.log(`  貴人: ${reading.relationships.贵人类.join(', ')}`);
console.log(`  小人特徵: ${['脾氣暴躁', '愛搬弄是非'].join(', ')}`);
console.log(`  建議: ${reading.relationships.advice}`);
console.log('');
